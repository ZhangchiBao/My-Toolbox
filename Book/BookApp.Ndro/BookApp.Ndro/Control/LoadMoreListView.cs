...
namespace BookApp.Ndro.Control
{
    public class LoadMoreListView : ListView
    {
        ...
        public LoadMoreListView() : base(ListViewCachingStrategy.RecycleElement)
        {
            ...
            ItemTapped += LoadMoreListView_ItemTapped;
        }

        private void LoadMoreListView_ItemTapped(object sender, ItemTappedEventArgs e)
        {
            if (sender is LoadMoreListView view)
            {
                var command = view.ItemTappedCommand;
        ...
        public static readonly BindableProperty ItemTappedCommandProperty =
            BindableProperty.Create("ItemTappedCommand", typeof(Command), typeof(LoadMoreListView), default(Command));
